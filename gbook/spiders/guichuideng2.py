...
#from gbook.items import GbookItem
  ...
  Last Modified: 2016/1/15 17:02:21
...
import codecs
import os
class Guichuideng2Spider(scrapy.Spider):
    name = "guichuideng2"
    ...
    def __init__(self, category=None, *args, **kwargs):
        super(Guichuideng2Spider, self).__init__(*args, **kwargs)
    ...
    def parse(self, response):
        ...
        home_title="在在".decode("utf-8")
        self.add_book("index5.html",html,home_title)
